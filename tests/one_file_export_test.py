...
class TestFileExport:
    ...
    def test_svg_export(self, test_dir: Path, 
        ...
        """
        svg_figure_path = test_dir / "test_folder1" / "Rectangle1_svg.svg"
    ...
    def test_drawio_export(self, 
        ...
        Args:
            ...
            test_export_dir: The path of the test export directory.
        """
        drawio_figure_path = test_dir / "test_folder1" / "Rectangle1_drawio.drawio"

        # Convert the input Drawio file
        drawio_exporter = DrawioExporter(drawio_path, export_format)
    ...
    def test_puml_export(self, 
        ...
        Args:
            ...
            test_export_dir: The path of the test export directory.
        """
        puml_figure_path = test_dir / "test_folder1" / "Sequence1_puml.puml"

        jar_path = os.path.join(test_dir, "plantuml.jar")
        puml_exporter = PumlExporter(jar_path, plantuml_url, export_format)
